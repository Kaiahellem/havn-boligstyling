  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        subheading: ["22px", { lineHeight: "1.2", letterSpacing: "0.04em" }],
        "heading-sm": ["24px", { lineHeight: "1.2", letterSpacing: "0.04em" }],
        heading: ["30px", { lineHeight: "1.1", letterSpacing: "0.04em" }],
        display: ["46px", { lineHeight: "1.05", letterSpacing: "0.04em" }],
      },
      boxShadow: {
